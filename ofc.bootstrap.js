...
const GA_MEASUREMENT_ID = "G-VYDN60F6T6";
...
function gtag_report_conversion(url) {
  ...
  gtag("event", "conversion", {
    send_to: "AW-17830635239/OCryCMPlgPgbEOfNp7ZC",
    value: 0.1,
    currency: "AED",
...
(async function initDisplayAds() {
  ...
  const adSlots = [
    { adUnit: "/23330730517/playblaze.in_d1", divId: "myw_top_1" },
    { adUnit: "/23330730517/playblaze.in_d2", divId: "myw_top_2" },
    { adUnit: "/23330730517/playblaze.in_d3", divId: "myw_top_3" },
  ];
    ...
    googletag.cmd.push(function () {
      try {
        ...
        currentSlot = googletag
          .defineOutOfPageSlot(
            "/23330730517/playblaze.in_reward",
